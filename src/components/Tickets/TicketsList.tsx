  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-3xl font-bold text-gray-900">Tickets de Soporte</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-white rounded-lg border border-orange-200 p-4">
          <p className="text-sm text-orange-600 mb-1">Abiertos</p>
        ...
        <div className="bg-white rounded-lg border border-green-200 p-4">
          <p className="text-sm text-green-600 mb-1">Resueltos</p>
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-4 text-sm">
                        ...
                        <span className="text-gray-500">{new Date(ticket.created_at).toLocaleDateString('es-ES')}</span>
                        {profile?.role !== 'user' && (
                          <span className="text-gray-500">
