    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-xl max-w-6xl w-full max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-slate-700">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Asignación Masiva de Usuarios</h2>
        ...
        <div className="flex-1 overflow-hidden flex">
          ...
          <div className="w-1/3 border-r border-gray-200 dark:border-slate-700 flex flex-col">
            <div className="p-4 border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-900/50">
              <h3 className="font-semibold text-gray-900 dark:text-white mb-3">Seleccionar Usuarios</h3>
              ...
              <div className="flex gap-2 mb-3">
                <button
                  ...
                  className="text-xs px-2 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded hover:bg-blue-200 dark:hover:bg-blue-800 transition"
                >
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 text-sm border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
            </div>
            <div className="flex-1 overflow-y-auto p-4 space-y-2 forums-scroll">
              {filteredUsers.map((user) => {
                ...
                return (
                  <label
                    key={user.id}
                    className={`flex items-center gap-3 p-3 hover:bg-gray-50 dark:hover:bg-slate-700 rounded-lg cursor-pointer border ${
                      selectedUsers.has(user.id) ? 'border-blue-400 dark:border-blue-500 bg-blue-50 dark:bg-blue-900/30' : 'border-gray-200 dark:border-slate-600'
                    }`}
                  >
                    <input
                      type="checkbox"
          ...
          <div className="flex-1 flex flex-col">
            <div className="p-4 border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-900/50">
              <h3 className="font-semibold text-gray-900 dark:text-white mb-3">Asignar Clientes</h3>
                ...
                <div className="mb-3">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="text-xs px-3 py-1.5 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded hover:bg-green-200 dark:hover:bg-green-800 transition"
                    >
                    ...
                    <button
                      ...
                      className="text-xs px-3 py-1.5 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 rounded hover:bg-red-200 dark:hover:bg-red-800 transition"
                    >
            ...
            <div className="flex-1 overflow-y-auto p-4 forums-scroll">
                ...
                <div className="space-y-2">
                  {filteredClients.map((client) => {
                    ...
                    return (
                      <div
                        key={client.id}
                        className="border border-gray-200 dark:border-slate-600 rounded-lg p-3 hover:bg-gray-50 dark:hover:bg-slate-700 transition"
                      >
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex-1">
                            <p className="font-medium text-gray-900 dark:text-white text-sm">{client.name}</p>
                            <p className="text-xs text-gray-500 dark:text-gray-400">{client.client_name}</p>
                          </div>
