...
if exist "dist\FABINSA_0.8.exe" del "dist\FABINSA_0.8.exe"

echo.
echo Iniciando compilacion con PyInstaller...
pyinstaller --clean FABINSA_0.8.spec

echo.
if exist "dist\FABINSA_0.8.exe" (
    echo ========================================
    echo   COMPILACION EXITOSA!
    echo ========================================
    echo.
    echo El ejecutable se ha creado en: dist\FABINSA_0.8.exe
    echo.
    echo Archivos necesarios para distribucion:
    echo - dist\FABINSA_0.8.exe
    echo - logo_fabinsa.png
    echo - plantilla_stock.xlsx
    echo - README_FABINSA_0.7.md
