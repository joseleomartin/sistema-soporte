-- ============================================
-- ACTUALIZAR ASUNTO DE TODAS LAS NOTIFICACIONES
-- ============================================
-- Cambia el asunto de TODAS las notificaciones para incluir "EmaGroup Notificaciones"
-- ============================================

-- 1. ACTUALIZAR: notify_ticket_comment() - Comentarios en tickets
-- ============================================
...
-- 2. ACTUALIZAR: notify_ticket_status_change() - Cambios de estado en tickets
-- ============================================
...
-- 3. ACTUALIZAR: notify_calendar_event() - Eventos de calendario
-- ============================================
...
-- 4. ACTUALIZAR: notify_task_assigned() - Asignación de tareas
-- ============================================
...
-- 5. ACTUALIZAR: create_task_mention_notifications() - Menciones en tareas
-- ============================================
...
-- 6. ACTUALIZAR: create_forum_mention_notifications() - Menciones en foros
-- ============================================
  ...
  LOOP
    ...
    IF mentioned_user_id != p_mentioner_id THEN
      ...
      VALUES (
        mentioned_user_id,
        'forum_mention',
        'EmaGroup Notificaciones: Fuiste mencionado en el chat de ' || COALESCE(subforum_client_name, subforum_name),
        mentioner_name || ' te mencionó: ' || p_message_preview,
        p_subforum_id,
        jsonb_build_object(
          'mentioner_id', p_mentioner_id,
...
-- ============================================
-- Ahora todos los asuntos de email mostrarán:
-- "EmaGroup Notificaciones: [título original]"
-- ============================================
