...
-- ==================================================================
-- Ir a: https://supabase.com/dashboard/project/yevbgutnuoivcuqnmrzi/editor
-- Copiar y pegar este script completo en el editor SQL y ejecutar
-- ==================================================================
...
-- VERIFICACIÓN
-- ==================================================================
-- Ejecutar esto para verificar que la migración se aplicó correctamente:
-- SELECT column_name, data_type FROM information_schema.columns WHERE table_name = 'tasks' AND column_name = 'is_personal';
-- SELECT policyname FROM pg_policies WHERE tablename = 'tasks' AND policyname LIKE '%personal%';
